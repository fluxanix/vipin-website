...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 z-50 pt-4 sm:pt-8 px-2 sm:px-4">
      <header className="w-full max-w-7xl mx-auto py-2 sm:py-3 px-2 sm:px-6 md:px-8 flex items-center justify-between">
        ...
        {/* Mobile menu button */}
        <button 
          className="md:hidden p-2 sm:p-3 rounded-2xl text-muted-foreground hover:text-foreground"
        ...
        {/* Mobile navigation */}
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-16 sm:top-20 left-2 sm:left-4 right-2 sm:right-4 bg-background/95 backdrop-blur-md py-3 sm:py-4 px-4 sm:px-6 border border-border rounded-2xl shadow-lg z-50">
        ...
        <div className="hidden md:flex items-center gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-1 sm:gap-2 rounded-full px-2 sm:px-3 py-1 sm:py-2">
          ...
          <div className="rounded-2xl">
            <Button variant="ghost" className="text-muted-foreground hover:text-foreground hover:bg-muted text-xs sm:text-base">Log in</Button>
          </div>
        </div>
      </header>
    </div>
